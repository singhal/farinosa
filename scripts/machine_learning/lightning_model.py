...
class EnceliaModel(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # self.log_dict({'valid_loss': loss, 'valid_acc': accuracy}, on_step=False, on_epoch=True, sync_dist=True)
        self.log_dict({'valid_loss': loss}, on_step=False, on_epoch=True, sync_dist=True)
        return loss
