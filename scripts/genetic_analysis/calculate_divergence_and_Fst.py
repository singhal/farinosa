...
def get_divergence(lineage, inds, vcf):
	diff = { '0/0': {'0/1': 0.5, '1/1': 1, '0/0': 0},
		'0/1': {'0/1': 0.5, '1/1': 0.5, '0/0': 0.5},
...
def get_data(args):
	...
	return lineage, inds, vcf


def main():
	args = get_args()
	lineage, inds, vcf = get_data(args)
	get_divergence(lineage, inds, vcf)
